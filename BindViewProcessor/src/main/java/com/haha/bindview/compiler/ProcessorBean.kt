...
class ProcessorBean {
    ...
    val variableElements: MutableList<VariableElement> by lazy { mutableListOf() }
    val methodElements: MutableList<ExecutableElement> by lazy { mutableListOf() }
    ...
    fun addVariableElement(variableElement: VariableElement?) {
        variableElement?.let { variableElements.add(it) }
    }

    fun addMethodElement(executableElement: ExecutableElement?) {
        executableElement?.let { methodElements.add(it) }
    }
}
