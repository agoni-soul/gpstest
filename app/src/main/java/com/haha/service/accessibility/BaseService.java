package com.haha.service.accessibility;
...
public class BaseService extends AccessibilityService {
    ...
    /**
     * 模拟点击事件,如果该node不能点击࿰c;则点击父node࿰c;将点击事件一直向父级传递࿰c;直至到根node或者找到一个可以点击的node
     *
    ...
    /**
     * 点击对应文本的一个view࿰c;前提是这个view能够点击࿰c;即 Clickable == true࿰c;
     *
     * @param text 要查找的文本
     */
    ...
    /**
     * 点击对应id的一个view࿰c;前提是这个view能够点击࿰c;即 Clickable == true࿰c;
     *
     * @param id 要查找的id
     */
    ...
    /**
     * 递归遍历node及其子node࿰c;点击文本相同的节点࿰c;全点击
     *
     * @param text
     * @param parentNode
     */
    ...
    public List<AccessibilityNodeInfo> findNodesByText(String text) {
        ...
        while (!nodeStack.isEmpty()) {
            ...
            //获得节点的子节点࿰c;对于二叉树就是获得节点的左子结点和右子节点
    ...
    /**
     * 手势操作࿰c;因为path不能小于0࿰c;因此小于则直接返回࿰c;不操作࿰c;另外如果有需求࿰c;可以自行修改小于则设置为0或者屏幕的宽高
     *
     * @param moveToX
     * @param moveToY
     * @param lineToX
