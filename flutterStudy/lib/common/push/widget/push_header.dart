...
import 'package:flutter_study/widget/haha_icon_text.dart';
import 'package:flutter_study/widget/haha_user_icon_widget.dart';
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Row(
                          children: <Widget>[
                            _getIconItem(HahaIcons.PUSH_ITEM_EDIT,
                                pushHeaderViewModel.editCount),
                            Container(width: 8.0),
                            _getIconItem(HahaIcons.PUSH_ITEM_ADD,
                                pushHeaderViewModel.addCount),
                            Container(width: 8.0),
                            _getIconItem(HahaIcons.PUSH_ITEM_MIN,
...
class PushHeaderViewModel {
  ...
  String addCount = "---";
  String deleteCount = "---";
  String? htmlUrl = HahaConstant.app_default_share_url;
