...
import 'package:flutter_study/page/issue/widget/issue_header_item.dart';
import 'package:flutter_study/page/issue/widget/issue_item.dart';
...
import '../../widget/pull/haha_pull_load_widget.dart';
              ...
              return Center(
                child: Container(
                  decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          color: HahaColors.subTextColor, width: 0.3)),
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      HahaFlexButton(
                        color: HahaColors.white,
                        textColor: HahaColors.primaryDarkValue,
                        text: "issue_edit_issue_edit_commit",
                        onPress: () {
                      ...
                      HahaFlexButton(
                        color: HahaColors.white,
                        text: "issue_edit_issue_delete_commit",
                        onPress: () {
                      ...
                      HahaFlexButton(
                        color: HahaColors.white,
                        text: "issue_edit_issue_copy_commit",
                        onPress: () {
            ...
            Row(
              ...
              children: [
                TextButton(
                  ...
                  child: Text("issue_reply",
                      style: HahaConstant.smallText),
                ),
                Container(
                    width: 0.3,
                    height: 30.0,
