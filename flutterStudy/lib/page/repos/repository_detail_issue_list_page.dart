...
import '../issue/widget/issue_item.dart';
import '../search/widget/haha_search_input_widget.dart';
...
class RepositoryDetailIssuePageState extends State<RepositoryDetailIssuePage>
    with
        ...
        HahaListState<RepositoryDetailIssuePage>,
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        flexibleSpace: (provider.repository?.hasIssuesEnabled == false)
            ? Container()
            : HahaSearchInputWidget(onSubmitted: (value) {
                searchText = value;
                _resolveSelectIndex();
              }, onSubmitPressed: () {
                _resolveSelectIndex();
            ...
            builder: (BuildContext context, double shrinkOffset,
              ...
              return SizedBox.expand(
                child: Padding(
                  ...
                  child: HahaSelectItemWidget(
                    [
                      "repos_tab_issue_all",
                      "repos_tab_issue_open",
                      "repos_tab_issue_closed",
                    ],
                    (selectIndex) {
