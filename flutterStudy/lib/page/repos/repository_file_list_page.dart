...
import '../../common/repository/data_result.dart';
...
class RepositoryDetailFileListPageState
  ...
  _renderEventItem(index) {
    ...
    return HahaCardItem(
      ...
      child: ListTile(
        title: Text(fileItemViewModel.name!, style: HahaConstant.smallSubText),
        leading: Icon(
          iconData,
          size: 16.0,
        ),
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          return RawMaterialButton(
            ...
            child:
                Text("${headerList[index]} > ", style: HahaConstant.smallText),
          );
        },
