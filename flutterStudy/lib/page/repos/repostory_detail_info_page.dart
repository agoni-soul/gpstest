...
import 'package:flutter_study/page/repos/widget/repos_header_item.dart';
...
class ReposDetailInfoPageState extends State<ReposDetailInfoPage>
    with
        ...
        HahaListState<ReposDetailInfoPage>,
  ...
  List<Widget> _getBottomWidget(ReposDetailProvider provider) {
    ...
    List<Widget> bottomWidget = (provider.bottomModel == null)
        ...
        : <Widget>[
            ...
            ///fork
            _renderBottomItem("fork", HahaIcons.REPOS_ITEM_FORK, () {
              CommonUtils.showLoadingDialog(context);
  ...
  _renderBottomItem(var text, var icon, var onPressed) {
    return TextButton(
      ...
      child: HahaIconText(
        icon,
        text,
        HahaConstant.smallText,
        HahaColors.primaryValue,
        15.0,
        padding: 5.0,
