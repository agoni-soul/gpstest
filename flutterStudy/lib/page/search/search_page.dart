...
import 'package:flutter_study/page/search/search_bloc.dart';
import 'package:flutter_study/page/search/widget/haha_search_drawer.dart';
import 'package:flutter_study/page/search/widget/haha_search_input_widget.dart';

import '../../common/utils/navigator_utils.dart';
import '../../widget/haha_select_item_widget.dart';
import '../../widget/pull/haha_pull_load_widget.dart';
import '../../widget/state/haha_list_state.dart';
import '../repos/widget/repos_item.dart';
import '../user/widget/user_item.dart';
...
class SearchBottom extends StatelessWidget implements PreferredSizeWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: <Widget>[
        HahaSearchInputWidget(
            controller: textEditingController,
            onSubmitted: onSubmitted,
            onSubmitPressed: onSubmitPressed),
        HahaSelectItemWidget(
          [
            "search_tab_repos",
            "search_tab_user",
          ],
