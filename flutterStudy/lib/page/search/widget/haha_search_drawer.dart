...
class HahaSearchDrawer extends StatefulWidget {
  ...
  const HahaSearchDrawer(this.typeCallback, this.sortCallback, this.languageCallback, {super.key});

  @override
  _HahaSearchDrawerState createState() => _HahaSearchDrawerState();
}

class _HahaSearchDrawerState extends State<HahaSearchDrawer> {
  ...
  _renderList() {
    ...
    list.add(_renderTitle("search_type"));
    ...
    list.add(_renderTitle("search_sort"));
    ...
    list.add(_renderTitle("search_language"));
  ...
  _renderTitle(String title) {
    return Container(
      ...
      child: Center(
        child: Text(
          title,
          style: HahaConstant.middleTextWhite,
