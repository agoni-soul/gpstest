...
import 'package:flutter_study/page/trend/trend_provider.dart';
...
import '../repos/repository_detail_page.dart';
import '../repos/widget/repos_item.dart';
      ...
      child: Padding(
        ...
        child: Row(
          children: <Widget>[
            ...
            Container(height: 10.0, width: 0.5, color: HahaColors.white),
  ...
  _renderHeaderPopItem(String data, List<TrendTypeModel> list,
    ...
    return Expanded(
      child: PopupMenuButton<TrendTypeModel>(
        ...
        child: Center(child: Text(data, style: HahaConstant.middleTextWhite)),
      ),
    );
  }
      ...
      child: SizedBox(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text("app_empty", style: HahaConstant.normalText),
          ],
        ),
      ),
    );
...
List<TrendTypeModel> trendTime(BuildContext context) {
  return [
    TrendTypeModel("trend_day", "daily"),
    TrendTypeModel("trend_week", "weekly"),
    TrendTypeModel("trend_month", "monthly"),
  ];
}
