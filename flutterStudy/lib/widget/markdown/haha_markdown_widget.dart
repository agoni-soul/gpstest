...
import 'package:flutter_study/widget/markdown/syntax_high_lighter.dart';
...
class HahaMarkdownWidget extends StatelessWidget {
    ...
    return markdownStyleSheet
        .copyWith(
            codeblockDecoration: BoxDecoration(
                ...
                border: Border.all(color: HahaColors.subTextColor, width: 0.3)))
        .copyWith(
            blockquoteDecoration: BoxDecoration(
                borderRadius: const BorderRadius.all(Radius.circular(4.0)),
                color: HahaColors.subTextColor,
                border: Border.all(color: HahaColors.subTextColor, width: 0.3)),
            blockquote: HahaConstant.smallTextWhite);
  }

  _getStyleSheetDark(BuildContext context) {
    return _getCommonSheet(context, const Color.fromRGBO(40, 44, 52, 1.00))
        .copyWith(
      p: HahaConstant.smallTextWhite,
      h1: HahaConstant.largeLargeTextWhite,
      h2: HahaConstant.largeTextWhiteBold,
      h3: HahaConstant.normalTextMitWhiteBold,
      h4: HahaConstant.middleTextWhite,
      h5: HahaConstant.smallTextWhite,
      h6: HahaConstant.smallTextWhite,
      em: const TextStyle(fontStyle: FontStyle.italic),
      strong: HahaConstant.middleTextWhiteBold,
      code: HahaConstant.smallSubText,
    );
  }
  ...
  _getStyleSheetWhite(BuildContext context) {
    return _getCommonSheet(context, const Color.fromRGBO(40, 44, 52, 1.00))
        .copyWith(
      p: HahaConstant.smallText,
      h1: HahaConstant.largeLargeText,
      h2: HahaConstant.largeTextBold,
      h3: HahaConstant.normalTextBold,
      h4: HahaConstant.middleText,
      h5: HahaConstant.smallText,
      h6: HahaConstant.smallText,
      strong: HahaConstant.middleTextBold,
      code: HahaConstant.smallSubText,
    );
  }
  ...
  _getBackgroundColor(BuildContext context) {
    Color background = HahaColors.white;
    switch (style) {
      case DARK_LIGHT:
        background = HahaColors.primaryLightValue;
        break;
      case DARK_THEME:
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Markdown(
        ...
        syntaxHighlighter: HahaHighlighter(),
        ...
        onTapLink: (String text, String? href, String title) {
          CommonUtils.hahaLaunchUrl(context, href);
        },
      ),
    );
  }
...
class HahaHighlighter extends SyntaxHighlighter {
  @override
