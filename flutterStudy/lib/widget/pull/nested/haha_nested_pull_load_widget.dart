...
import '../haha_pull_load_widget.dart';
import 'nested_refresh.dart';

///通用下上刷新控件
class HahaNestedPullLoadWidget extends StatefulWidget {
  ///item渲染
  ...
  const HahaNestedPullLoadWidget(
  ...
  @override
  _HahaNestedPullLoadWidgetState createState() =>
      _HahaNestedPullLoadWidgetState();
}

class _HahaNestedPullLoadWidgetState extends State<HahaNestedPullLoadWidget> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget _buildProgressIndicator() {
    ...
    Widget bottomWidget = (widget.control.needLoadMore.value)
        ? Row(mainAxisAlignment: MainAxisAlignment.center, children: <Widget>[
            ...
            ///加载中文本
            Text(context.l10n.load_more_text,
