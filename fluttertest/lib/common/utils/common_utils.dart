...
import '../../page/issue/issue_edit_dIalog.dart';
...
class CommonUtils {
  ...
  static String getUserChartAddress(String userName) {
    return "${Address.graphicHost}${HahaColors.primaryValueString.replaceAll("#", "")}/$userName";
  }
  ...
  static hahaLaunchUrl(BuildContext context, String? url) {
  ...
  static Future<void> showLoadingDialog(BuildContext context) {
    return NavigatorUtils.showHahaDialog(
        context: context,
                ...
                child: Center(
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        const SpinKitCubeGrid(color: HahaColors.white),
