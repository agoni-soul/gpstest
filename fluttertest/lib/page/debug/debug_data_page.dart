...
import '../../common/net/interceptors/log_interceptor.dart';
import '../../common/toast.dart';
import '../../test/demo_tab_page.dart';
import '../../widget/flutter_json_widget.dart';
...
class _DebugDataPageState extends State<DebugDataPage> {
  ...
  Widget build(BuildContext context) {
    return TabWidget(
        ...
        title: const Text(
          "Debug",
          style: TextStyle(color: HahaColors.white),
        ),
        tabViews: [
        ...
        indicatorColor: HahaColors.primaryValue,
        onTap: (index) {
          setState(() {
            tabIndex = index;
          });
