...
class _ReposHeaderItemState extends State<ReposHeaderItem> {
      ...
      child: Center(
          child: RawMaterialButton(
              ...
              child: HahaIconText(
                icon,
                text,
                HahaConstant.smallSubLightText.copyWith(shadows: [
  ...
  _renderTopicItem(BuildContext context, String item, index) {
    return RawMaterialButton(
        ...
        child: Container(
          ...
          child: Text(
            item,
            style: HahaConstant.smallSubLightText.copyWith(shadows: [
              const BoxShadow(color: Colors.grey, offset: Offset(0.5, 0.5))
            ]),
          ),
        ));
  ...
  _getInfoText(BuildContext context) {
    String createStr = widget.reposHeaderViewModel.repositoryIsFork!
        ? '${"repos_fork_at"}${widget.reposHeaderViewModel.repositoryParentName!}\n'
        : "${"repos_create_at"}${widget.reposHeaderViewModel.created_at}\n";

    String updateStr =
        "repos_last_commit" + widget.reposHeaderViewModel.push_at;
      ...
      children: <Widget>[
        ...
        RawMaterialButton(
          ...
          child: Text(widget.reposHeaderViewModel.ownerName!,
              style: HahaConstant.normalTextActionWhiteBold.copyWith(shadows: [
                const BoxShadow(color: Colors.black, offset: Offset(0.5, 0.5))
              ])),
        ),
        Text(" / ",
            style: HahaConstant.normalTextMitWhiteBold.copyWith(shadows: [
              const BoxShadow(color: Colors.black, offset: Offset(0.5, 0.5))
            ])),
      ...
      child: RawMaterialButton(
        ...
        child: Text(_getInfoText(context),
            style: widget.reposHeaderViewModel.repositoryIsFork!
                ? HahaConstant.smallActionLightText.copyWith(shadows: [
                    const BoxShadow(
